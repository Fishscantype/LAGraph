//------------------------------------------------------------------------------
// LAGraph/src/test/test_Random_Graph.c: test cases for random matrix generator
//------------------------------------------------------------------------------
...
void test_Random_Graph (void)
{
    ...
    for (int trial = 0 ; trial <= 4 ; trial++)
    {
        seed++ ;
        printf ("\n=============================== seed: %g\n", (double) seed) ;
        OK (LG_SET_JIT ((trial == 4 || trial == 2) ? LG_JIT_OFF : LG_JIT_ON)) ;
...
TEST_LIST = {
    {"Random_Graph", test_Random_Graph},
    {NULL, NULL}
};
